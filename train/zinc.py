...
def create_model(cfg):
    model = GNNAsKernel(None, None, 
                        ...
                        use_page_rank=cfg.model.use_page_rank,
                        use_distance_encoding=cfg.model.use_distance_encoding,
                        use_de_mean=cfg.model.use_de_mean,
                        use_de_max=cfg.model.use_de_max,
